...
<head>
    ...
    <title>ToDayList - Tu Gestor de Tareas Diarias</title>

    <!-- 1. Enlace al archivo CSS -->
    <!-- Esta ruta asume que 'style.css' está en la MISMA CARPETA que este 'index.html' -->
    <link rel="stylesheet" href="style.css">

    <!-- 2. Enlace a Font Awesome para los iconos -->
    <!-- Usando Font Awesome 5.15.4. Si necesitas v6, actualiza este enlace. -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-1ycn6IcaQQ40/MKBW2W4Rhis/DbILU74C1vSrLJxCq57o941Ym01SwNsOMqvEBFlcgUA6xLiPY/NS5R+E6ztJQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />

    <!-- 3. Favicon (Opcional) -->
    <!-- Si tienes un favicon.ico en la misma carpeta, puedes descomentar esto: -->
...
<body>
    ...
    <!-- 4. Script para confetti (externo) -->
    <script src="https://cdn.jsdelivr.net/npm/canvas-confetti@1.5.1/dist/confetti.browser.min.js"></script>

    <!-- 5. Scripts de Google API (para Drive y Picker) -->
    <!-- Estos deben cargarse ANTES de tu script.js si tu script depende de ellos al inicio -->
    <script async defer src="https://apis.google.com/js/api.js"
            onload="console.log('GAPI script loaded, setting flag and attempting callback.');
                    window.isGoogleGapiScriptReady = true;
                    if (typeof window.googleApiCallbacks !== 'undefined' && typeof window.googleApiCallbacks.gapiLoaded === 'function') {
                        window.googleApiCallbacks.gapiLoaded();
                    } else {
                        console.log('GAPI script loaded, but googleApiCallbacks.gapiLoaded not (yet) a function or googleApiCallbacks is undefined.');
                    }">
    </script>
    <script async defer src="https://accounts.google.com/gsi/client"
            onload="console.log('GIS client script loaded, setting flag and attempting callback.');
                    window.isGoogleGisScriptReady = true;
                    if (typeof window.googleApiCallbacks !== 'undefined' && typeof window.googleApiCallbacks.gisLoaded === 'function') {
                        window.googleApiCallbacks.gisLoaded();
                    } else {
                        console.log('GIS client script loaded, but googleApiCallbacks.gisLoaded not (yet) a function or googleApiCallbacks is undefined.');
                    }">
    </script>

    <!-- 6. Enlace a tu archivo JavaScript principal -->
    <!-- Esta ruta asume que 'script.js' está en la MISMA CARPETA que este 'index.html' -->
    <!-- 'type="module"' implica comportamiento 'defer' por defecto -->
